...
:root {
  /* Updated theme for healthcare/medical aesthetic with soft blue, cream, coral accents */
  ...
  /* Custom variables for medical theme */
...
@theme inline {
  ...
  /* Additional color mappings for custom variables */
