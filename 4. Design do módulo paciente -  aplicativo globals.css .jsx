...
:root {
  ...
  --background: oklch(0.98 0.005 240); /* Soft white with slight blue tint */
  --foreground: oklch(0.2 0.01 240); /* Deep blue-gray for text */
  --card: oklch(1 0 0);
  ...
  --destructive: oklch(0.55 0.22 25); /* Medical red */
  ...
  --medical-blue: oklch(0.65 0.15 240);
  --medical-green: oklch(0.65 0.15 150);
  --medical-yellow: oklch(0.82 0.15 85);
  --medical-red: oklch(0.55 0.22 25);
  --medical-purple: oklch(0.55 0.15 290);
...
.dark {
  ...
  --medical-blue: oklch(0.55 0.15 240);
  --medical-green: oklch(0.55 0.15 150);
  --medical-yellow: oklch(0.72 0.15 85);
  --medical-red: oklch(0.45 0.22 25);
  --medical-purple: oklch(0.5 0.15 290);
...
@theme inline {
  ...
  --color-medical-yellow: var(--medical-yellow);
  --color-medical-red: var(--medical-red);
  --color-medical-purple: var(--medical-purple);
}
